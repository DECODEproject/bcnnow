...
from backend.data.collectors.pull.PointsInterestCollector.Config import Config as collectorConfig
collectorCfg = collectorConfig().get()

from config.Config import Config as globalConfig
globalCfg = globalConfig().get()

from backend.data.collectors.pull.PointsInterestCollector.PointsInterestPayload import PointsInterestPayload
